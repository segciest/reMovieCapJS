...
const arrMenu = [
  {
    ...
    children: [
      ...
      {
        label: <Link to={path.admin.editMovie}>Chỉnh sửa phim</Link>,
        icon: <i className="fa-solid fa-file-video"></i>,
      },
      {
        label: <Link to={path.admin.timelineset}>Thêm lịch chiếu</Link>,
        icon: <i className="fa-solid fa-file-video"></i>,
      },
    ],
  },
...
const AdminTemplate = () => {
  ...
  useEffect(() => {
    ...
    const dataUser = handleGetLocalStorage("dataUser");
